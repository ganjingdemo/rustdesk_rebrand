...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the 天潮云系统 network..."),
        ("not_ready_status", "Not ready. Please check your connection"),
        ("ID/Relay Server", "ID/Relay server"),
        ("id_change_tiFp", "Only a-z, A-Z, 0-9 and _ (underscore) characters allowed. The first letter must be a-z, A-Z. Length between 6 and 16."),
        ...
        ("install_tip", "Due to UAC, 天潮云系统 can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install 天潮云系统 to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant 天潮云系统 \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant 天潮云系统 \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow 天潮云系统 to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [天潮云系统 Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next 天潮云系统 application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant 天潮云系统 \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant 天潮云系统 \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running 天潮云系统."),
        ...
        ("verify_rustdesk_password_tip", "Verify 天潮云系统 password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use 天潮云系统 and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade 天潮云系统 Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent 天潮云系统 from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by 天潮云系统"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if 天潮云系统 window is open"),
        ...
        ("floating_window_tip", "It helps to keep 天潮云系统 background service"),
